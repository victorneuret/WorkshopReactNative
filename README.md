...
Pour la mise en page de votre application, plusieurs règles de style peuvent être utilisées. Je vous renvoie vers la documentation officiel très complète : 
